...
interface KukuFarmerInterface extends ethers.utils.Interface {
  functions: {
    ...
    "pendingKuku(uint256,address)": FunctionFragment;
...
export class KukuFarmer extends Contract {
  ...
  functions: {
    ...
    KukuPerBlock(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    KukuPerBlock(overrides?: CallOverrides): Promise<PopulatedTransaction>;
